                    ...
                    <>
                        ...
                        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-1.5 z-30">
                            {screens.map((_, i) => (
                                <div 
                                    key={i} 
                                    className={`w-1.5 h-1.5 rounded-full transition-all ${i === current ? 'bg-[#8FAEC7] w-4' : 'bg-white/30'}`}
                                />
                            ))}
                        </div>
                    </>
...
const QuickSalonPage = () => {
    ...
    const features = [
        { name: "Appointment Booking", icon: <Calendar className="text-[#8FAEC7]" /> },
        { name: "Real-time Notifications", icon: <Bell className="text-[#4E3629]" /> },
        { name: "Digital Payments", icon: <CreditCard className="text-[#8FAEC7]" /> },
        { name: "User Authentication", icon: <UserCheck className="text-[#4E3629]" /> },
        { name: "Booking Management", icon: <Layout className="text-[#8FAEC7]" /> },
        { name: "Smooth UI/UX", icon: <Smartphone className="text-[#4E3629]" /> },
    ];
    ...
    return (
        <main className="bg-[#FAF9F6] min-h-screen font-sans pb-32 overflow-x-hidden">
            ...
            <section className="relative pt-40 pb-24 md:pt-56 md:pb-40 container max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-16 md:gap-24">
                ...
                >
                    <div className="inline-block px-4 py-2 bg-[#E9F0F6] border border-[#8FAEC7]/20 rounded-full text-[#4E3629] font-bold tracking-[0.2em] text-xs uppercase mb-4 shadow-sm">
                        Mobile Application
                    </div>
                    <h1 className="text-[60px] md:text-[90px] lg:text-[110px] leading-[0.85] font-[900] text-[#4E3629] font-[family-name:var(--font-headline)] tracking-tight uppercase">
                        QUICK<br/>
                        <span className="text-[#8FAEC7] font-[family-name:var(--font-cursive)] normal-case">Salon App</span>
                    </h1>
            ...
            <section className="py-24 bg-[#FAF9F6] border-y border-[#8FAEC7]/20 overflow-hidden relative">
                <div className="container max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32">
                    ...
                    >
                        ...
                        <div className="bg-[#1E140F] p-8 md:p-12 rounded-[40px] text-white shadow-2xl relative overflow-hidden group">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-[#8FAEC7]/10 rounded-full blur-[60px] -z-0"></div>
                            <div className="relative z-10 space-y-8">
                                <p className="text-xl md:text-2xl font-medium leading-relaxed italic opacity-90 text-[#FAF9F6]">
            ...
            {/* FEATURES SECTION */}
            <section className="py-24 bg-[#1E140F] text-white rounded-[60px] mx-6 md:mx-12 overflow-hidden relative my-12">
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#8FAEC7]/10 rounded-full blur-[150px] -z-10"></div>
                <div className="container max-w-7xl mx-auto px-6 lg:px-12">
                    <div className="mb-20 text-center flex flex-col items-center">
                        <SectionHeader title="Key Features" light />
                        <div className="w-24 h-1.5 bg-[#8FAEC7] rounded-full mb-8"></div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature, i) => (
                            <motion.div 
                                key={i}
                                className="p-10 rounded-[35px] bg-white/5 border border-[#8FAEC7]/20 backdrop-blur-md hover:bg-white/10 transition-all flex flex-col items-center text-center gap-6 group"
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
                            ...
                            >
                                ...
                                <span className="text-2xl font-[800] tracking-tight uppercase leading-none text-[#FAF9F6]">{feature.name}</span>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-32 container max-w-7xl mx-auto px-6 lg:px-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
                    {screenCategories.map((category, i) => (
                        <motion.div 
                            key={i}
                            className="bg-white rounded-[48px] p-6 border-2 border-[#8FAEC7]/30 hover:shadow-2xl hover:shadow-[#4E3629]/5 transition-all group"
                            variants={fadeIn}
                            initial="hidden"
                            whileInView="visible"
                            viewport={{ once: true }}
                ...
                <div className="container max-w-5xl mx-auto px-6 text-center space-y-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {[
                            ...
                            <motion.div 
                                key={i}
                                className="bg-[#FAF9F6] p-10 rounded-[40px] border-2 border-[#8FAEC7]/30 shadow-sm space-y-6"
                                variants={fadeIn}
                                initial="hidden"
                                whileInView="visible"
                                viewport={{ once: true }}
                            ...
                            >
                                <div className="w-12 h-12 bg-[#8FAEC7] rounded-2xl flex items-center justify-center text-white font-black text-xl mx-auto">
                                    {i + 1}
                                </div>
                ...
                <div className="space-y-12">
                    ...
                    <div className="flex flex-wrap gap-4">
                        {techStack.map((tech, i) => (
                            <motion.div 
                                key={i}
                                className="px-8 py-5 bg-white border-2 border-[#8FAEC7]/30 rounded-[28px] shadow-sm text-lg font-black text-[#4E3629] hover:border-[#8FAEC7] hover:bg-[#E9F0F6] transition-all cursor-default"
                ...
                <div className="space-y-12">
                    ...
                    <div className="space-y-8 relative">
                        {[
                            ...
                            <motion.div key={i} className="flex gap-8 items-center bg-white p-6 rounded-3xl border-2 border-[#8FAEC7]/30 shadow-sm" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
                                <div className="w-12 h-12 min-w-[48px] rounded-2xl bg-[#8FAEC7] text-white flex items-center justify-center font-black text-xl shadow-lg">
                                    {i + 1}
                                </div>
                                <p className="text-xl text-[#4E3629] font-bold tracking-tight uppercase leading-none">{step}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            <section className="container max-w-7xl mx-auto px-6 mb-32">
                <div className="p-12 md:p-20 rounded-[60px] bg-[#1E140F] text-white shadow-2xl relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#8FAEC7]/10 rounded-full blur-[100px] -z-0"></div>
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center text-center lg:text-left">
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    <div key={i} className="flex gap-4 justify-center lg:justify-start">
                                        ...
                                        <span className="font-bold text-xl uppercase tracking-tight text-[#FAF9F6]">{res}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        <div className="relative lg:pl-12">
                            <motion.div 
                                className="bg-white/5 border border-[#8FAEC7]/20 backdrop-blur-xl rounded-[48px] p-10 md:p-16 space-y-10 relative overflow-hidden"
                                initial={{ opacity: 0, scale: 0.95 }}
                                whileInView={{ opacity: 1, scale: 1 }}
                                viewport={{ once: true }}
                            >
                                <div className="absolute top-0 right-0 w-64 h-64 bg-[#8FAEC7]/20 rounded-full blur-[80px] -z-10"></div>
                                
                                <div className="space-y-4">
                                    <h4 className="text-3xl md:text-5xl font-black tracking-tighter uppercase leading-none text-[#FAF9F6]">
                                        Empowering <span className="text-[#8FAEC7]">Local Salons</span> With Global Tech
                                    </h4>
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="p-6 bg-white/5 rounded-3xl border border-white/5">
                                        <Trophy className="text-[#8FAEC7] mb-4" size={32} />
                                        <h5 className="text-2xl font-black text-[#FAF9F6]">98%</h5>
                                        <p className="text-xs uppercase font-bold tracking-widest text-slate-500">Uptime Rate</p>
                                    </div>
                                    <div className="p-6 bg-white/5 rounded-3xl border border-white/5">
                                        <Activity className="text-[#8FAEC7] mb-4" size={32} />
                                        <h5 className="text-2xl font-black text-[#FAF9F6]">1.2s</h5>
                                        <p className="text-xs uppercase font-bold tracking-widest text-slate-500">Avg. Response</p>
                                    </div>
                                </div>
                                
                                <div className="pt-6 border-t border-white/10 flex items-center gap-4">
                                    <Target className="text-[#8FAEC7]" />
